...
comment on table hub is 'Hub product instances';

insert into public.hub (id, machine_id, machine_secret_hash, pin) values
    ('99000001', 'ByZKOnpWVQAlTLYtAyxtiPOxULVZMDZf', 'emCUmqyySyDVjkVG4XCkTUpbwkTEd4AYIdBTCODbvtq9CL2PgmSrWV2pOamZEyOb', '123456'),
    ('99000002', 'EeAdaNtK48JRzaBtI15xYY9tCP9r97Dh', 'KAoWeQ0oyYLeOT9zwHa314JQJrnAV2VgNCjvqvdluXmnZRSdd0xBYnqmRbrfrNIv', '654321');
...
insert into auth.users (id, instance_id, email, email_confirmed_at, encrypted_password, aud, "role", raw_app_meta_data, raw_user_meta_data, created_at, updated_at, last_sign_in_at, confirmation_token, email_change, email_change_token_new, recovery_token) values
	('d9c444f1-4e91-4abb-b4c7-1d18318990e9', '00000000-0000-0000-0000-000000000000', 'example@aerl.cloud', '2023-02-24T19:57:41.849Z', '$2a$10$uFKPCIwHTZMrYF2lmfR1TOsJrNxm5rhJ1PQ/NrBwu7YkC2eXBpMZy', 'authenticated', 'authenticated', '{"provider":"email","providers":["email"]}', '{}', '2023-02-24T19:57:41.849Z', '2023-02-24T19:57:41.849Z', '2023-02-24T19:57:41.849Z', '', '', '', ''),
	('662adb80-2949-46fc-8cad-a3cb156ede6e', '00000000-0000-0000-0000-000000000000', 'example@acme.example.com', '2023-02-25T10:06:34.441Z', '$2a$10$uFKPCIwHTZMrYF2lmfR1TOsJrNxm5rhJ1PQ/NrBwu7YkC2eXBpMZy', 'authenticated', 'authenticated', '{"provider":"email","providers":["email"]}', '{}', '2023-02-25T10:06:34.441Z', '2023-02-25T10:06:34.441Z', '2023-02-25T10:06:34.441Z', '', '', '', '');

insert into auth.identities (id, user_id, "provider", identity_data, created_at, updated_at, last_sign_in_at) values
	('d9c444f1-4e91-4abb-b4c7-1d18318990e9', 'd9c444f1-4e91-4abb-b4c7-1d18318990e9', 'email', '{"sub":"d9c444f1-4e91-4abb-b4c7-1d18318990e9","email":"example@aerl.cloud"}', '2023-02-24T19:57:41.849Z', '2023-02-24T19:57:41.849Z', '2023-02-24T19:57:41.849Z'),
	('662adb80-2949-46fc-8cad-a3cb156ede6e', '662adb80-2949-46fc-8cad-a3cb156ede6e', 'email', '{"sub":"662adb80-2949-46fc-8cad-a3cb156ede6e","email":"example@acme.example.com"}', '2023-02-25T10:06:34.441Z', '2023-02-25T10:06:34.441Z', '2023-02-25T10:06:34.441Z');

--
-- Instances
--

insert into public.instance (id, stub, domain) values
    (1, 'aerl', 'aerl.cloud'),
    (2, 'acme', 'acme.example.com');
...
comment on table org_invite is 'Organization invitations';
comment on table org_member is 'Organization members';

--
-- Devices
--

comment on table device is 'Registered devices';
...
comment on table notification is 'Notifications';

--
-- Alerts
--

comment on table alert is 'Alert events';
comment on table alert_receiver is 'Alert recipients';
comment on table alert_rule is 'Alert rules';

--
-- Countries
--

comment on table country is 'Full list of countries.';
...
insert into public.country (name,iso2,iso3,local_name,continent) values
