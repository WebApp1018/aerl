...
import { Configuration, CreateCompletionRequest, OpenAIApi } from "https://esm.sh/openai@3.2.1";
...
serve(async (req) => {
  try {
    ...
    const prompt = codeBlock`
      ${oneLine`
        You are a very enthusiastic AERL representative who loves
        to help people! Given the following sections from the AERL Cloud
